...
import bojan.sampleJavaApp.CarRegistry.Adapters.RestApi.Services.CarService;
...
public class CarController {
    ...
    public ResponseEntity<Car> createCar(@Valid @RequestBody NewCar car) {
        return new ResponseEntity<>(carDataTransformer.transform(carService.createNewCar(car.getModel(), car.getBrand())), HttpStatus.CREATED);
    }
}
